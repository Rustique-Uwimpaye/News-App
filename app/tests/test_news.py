...
class TestNews(unittest.TestCase):
    '''
    Test the behavior of the News class
    '''
    def setUp(self):
        #will run before every test
        self.new_news=News("kenyan gazette","was established in the year  1954","https://newsapi.org/v2/sources","Kenyatta and some colonial government","https://kenya.org.com")
    ...
    def self_init(self):
        ...
        self.assertEqual(self.new_news.description,"was established in the year  1954")
